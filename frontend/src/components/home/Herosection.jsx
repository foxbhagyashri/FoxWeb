...
const Herosection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 md:flex items-center justify-center animate-fade-in pb-1 hidden md:block">
        <div className="relative w-full max-w-lg aspect-square flex items-center justify-center">

          {/* Orbital Rings */}
          <div className="absolute inset-8 border border-purple-400/20 dark:border-purple-500/30 rounded-full"></div>
