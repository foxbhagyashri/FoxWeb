...
function WebsiteDesign() {
  ...
  return (
    <div className="bg-[#F8FAFC] text-gray-800">
      ...
      <Helmet>
        <title>Web Development Company in Pune | Fox Aircomm
        </title>
        <meta name="description" content="Fox Aircomm is a web development company in Pune offering website design, eCommerce development, and WordPress solutions built to grow your business online." />
      </Helmet>
      ...
      <section className="relative py-20 md:py-24 bg-[#0529a0] text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="inline-flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-2 mb-8 px-5 py-2.5 rounded-full border border-white/20 bg-white/5 text-xs md:text-sm font-medium tracking-wide text-blue-100">
              <span className="text-white font-semibold">120+ Projects Delivered</span>
              <span className="text-white/30">•</span>
              <span>Pune · Mumbai · Ahmedabad</span>
              <span className="text-white/30">•</span>
              <span>WordPress · Laravel · React · Node.js</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight tracking-tight">
              Web Development Company in Pune That Builds Websites,{' '}
              <span className="text-[#f85415]">Google Ranks</span>, and{' '}
              <span className="text-[#f85415]">Customers' Trust</span>
            </h1>

            <p className="text-blue-100 text-lg mb-1">
              Every Pune business wants more traffic.
            </p>
            <p className="text-blue-100 text-lg mb-6">
              Very few realise it's not traffic that converts — it's trust.
            </p>

            <p className="text-xl font-semibold mb-10 max-w-xl mx-auto md:mx-0 leading-snug">
              Foxaircomm is a web development company in Pune combining creative designers,
              analytical marketers, and ethical coders under one roof. We build websites that
              make people believe in your brand the moment they land — and that Google finds
              worth ranking.
            </p>


            <a href="tel:8879864151"
              className="inline-flex items-center gap-2 bg-[#f85415] hover:bg-[#e04a0f] transition-colors px-8 py-4 text-white font-bold text-lg rounded-xl shadow-lg shadow-[#f85415]/30"
            >
          ...
          <div className="hidden md:flex justify-center">
            {/* paste the wireframe-to-website SVG shown above here */}
            <img src="/wireframe_to_website_hero_visual.png" alt="Wireframe to Website Visual" />
          </div>
